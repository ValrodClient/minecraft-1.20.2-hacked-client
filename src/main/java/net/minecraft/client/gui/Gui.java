...
public class Gui {
   ...
   private void renderCrosshair(GuiGraphics p_282828_) {
   ...
   protected void renderEffects(GuiGraphics p_282812_) {
   ...
   private void renderHotbar(float p_283031_, GuiGraphics p_282108_) {
